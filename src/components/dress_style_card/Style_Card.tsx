...
const Style_Cards: React.FC = () => {
    return (
        <div className="flex flex-col flex-wrap items-center justify-center bg-[#f0f0f0] rounded-2xl shadow-lg py-4 ">
            <h1 className="font-header uppercase sm:text-3xl text-2xl px-4">
